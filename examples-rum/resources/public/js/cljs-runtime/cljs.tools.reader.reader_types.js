...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_28788 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_28788(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_28793 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_28793(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_28798 = (function (reader,ch){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_28798(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_28813 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_28813(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_28820 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_28820(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_28847 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_28847(reader);
}
});
...
var G__28965 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__28966 = s.append(c);
c = G__28965;
s = G__28966;
continue;
}
