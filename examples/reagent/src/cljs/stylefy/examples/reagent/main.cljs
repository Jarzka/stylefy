(ns stylefy.examples.reagent.main
  (:require
    [garden.units :as gu]
    [garden.color :as gc]
    ...
    [stylefy.examples.reagent.table :as table]
    [stylefy.examples.reagent.hoverbox :as hoverbox]
    [stylefy.examples.reagent.grid :as grid]
    [stylefy.examples.reagent.full-page :as full-page]
    [stylefy.examples.reagent.custom-tags :as custom-tags]
...
(def scoped-box-style-with-manual-media-query
  {:font-weight :bold
...
(defn- scoped-box []
  [:div
   [:div (use-style scoped-box-style-with-manual-media-query)
   ...
   [:div.scoped-box
    [:div (use-style scoped-box-style-with-manual-media-query)
     ...
     [:p.green-text-in-scoped-box "This text is bold and green, as defined by scoped box style and it's manual mode. On small screens, the text turns purple."]]]])
